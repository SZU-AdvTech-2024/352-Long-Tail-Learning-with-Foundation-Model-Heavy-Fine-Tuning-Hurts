...
class IMBALANCECIFAR10(cifar10):
    ...
    def flip_labels_c_1(self, corruption_prob, num_classes, seed=1):
        ...
        torch.save(C, 'noisy_transaction_matrix_real_cifar.pt')
        return C
